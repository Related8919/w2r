...
def fetch_blog_posts(config):
    ...
    print(f"DEBUG: Found {len(blocks)} blocks using selector '{config['block_css']}'") 
...
- 原网址：{site['url']}
- 订阅源：https://raw.githubusercontent.com/Related8919/w2r/refs/heads/main/{file_name}
- Follow订阅跳转：[follow://add?url=https://raw.githubusercontent.com/Related8919/w2r/refs/heads/main/{file_name}](follow://add?url=https://raw.githubusercontent.com/Related8919/w2r/refs/heads/main/{file_name})\n\n""")
